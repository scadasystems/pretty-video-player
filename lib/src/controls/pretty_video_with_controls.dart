...
///      * Controls.
class PrettyVideoWithControls extends StatefulWidget {
  const PrettyVideoWithControls({
    Key? key,
    this.controls,
  ...
  /// Create custom controls or use any of these [PrettyPortraitControls], [PrettyLandscapeControls]
  ...
  /// Property passed to [PrettyVideoPlayer]
  ...
  @override
  _PrettyVideoWithControlsState createState() => _PrettyVideoWithControlsState();
}

class _PrettyVideoWithControlsState extends State<PrettyVideoWithControls> {
  VideoPlayerController? _videoPlayerController;
  @override
  void didChangeDependencies() {
    VideoPlayerController? newController = Provider.of<PrettyVideoManager>(context).videoPlayerController;
    if ((widget.willVideoPlayerControllerChange && _videoPlayerController != newController) ||
