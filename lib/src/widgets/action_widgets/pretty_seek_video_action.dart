...
/// GestureDetector's that calls [prettyControlManager.seekForward]/[prettyControlManager.seekBackward] onTap of opaque area/child.
///
...
class PrettySeekVideoAction extends StatelessWidget {
  const PrettySeekVideoAction({
    Key? key,
    this.child,
  ...
  ///
  /// This widget is shown for a duration managed by [PrettyDisplayManager].
