                        ...
                        child: Container(
                          child: PrettyVideoProgressBar(
                            flickProgressBarSettings: PrettyProgressBarSettings(
                              ...
                              getPlayedPaint: (
                                  {double? handleRadius, double? height, double? playedPart, double? width}) {
                                return Paint()
                                  ..shader = LinearGradient(
                                      colors: [Color.fromRGBO(108, 165, 242, 1), Color.fromRGBO(97, 104, 236, 1)],
